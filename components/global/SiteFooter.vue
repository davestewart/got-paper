<template>
  <footer class="footer">
    <!-- footer logos -->
    <img src="/images/social/splash-og.png" width="1" height="1" style="visibility: hidden; font-size: 1px;"
         alt="Got Paper logo">
    <img src="/images/social/splash-og.png" width="1" height="1" style="visibility: hidden; font-size: 1px;"
         alt="Got Paper icon">
    ...
    <div class="footer__amazon">
      ...
      <div class="inner text-center">
        <div class="col-12"><p>AmazonFresh offers same-day or next-day delivery for grocery orders to eligible
          postcodes. If you make a purchase we may receive a small commission at no extra cost to you.</p>
        </div>
      </div>
