<template>
  <footer class="footer">
    ...
    <div class="footer__amazon inner text-center">
      <div class="col-12">
        <p>We have partnered with Amazon Fresh to enable you to get toilet paper and groceries delivered directly to your door</p>
      </div>
    </div>
